...
An automated Windows setup script using Chocolatey and Winget to quickly install my essential development tools, IDEs, and utilities.
Runs in silent mode (auto-accepts licenses).
